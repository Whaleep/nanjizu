        ...
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="max-w-4xl mx-auto space-y-12">
                ...
                <div class="flex flex-col md:flex-row items-center relative">
                    <div class="w-16 h-16 flex items-center justify-center bg-blue-600 text-white rounded-full text-2xl font-bold mb-4 md:mb-0 md:mr-8 shrink-0 shadow-lg z-10">1</div>
                ...
                <div class="text-center pt-8">
                    <Link href="/repair" class="bg-blue-600 text-white px-8 py-3 rounded-lg text-lg font-bold hover:bg-blue-700 shadow-lg transition">
                        立即查詢報價
                    </Link>
                </div>
            </div>
