    ...
    <MainLayout>
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div v-for="store in stores" :key="store.id" class="bg-white p-6 rounded-lg shadow-lg border hover:border-blue-400 transition">
                    <h2 class="text-2xl font-bold mb-4 text-blue-800 flex items-center gap-2">
                        <span>📍</span> {{ store.name }}
                    </h2>

                    <div class="space-y-3 pl-2 border-l-2 border-gray-200 ml-2 mb-6">
                    ...
                    <!-- Google Maps Iframe -->
                    <div v-if="store.map_url" class="aspect-video w-full rounded-lg overflow-hidden border shadow-inner bg-gray-100 mb-6">
